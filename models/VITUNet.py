...
#https://www.kaggle.com/code/ganaianimesh/unet-with-vit#download-data
...
class VITUNet(nn.Module):
    def __init__(self, n_channels, n_classes, patch_size=16,bilinear=True):
        ...
        self.vit = ViT(image_size = 32,patch_size = self.patch_size,dim = 2048, depth = 2, heads = 16,mlp_dim = 12,channels = 512) #dim%head=0
