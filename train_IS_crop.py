...
def main_hyper():
    ...
    hyper_model = ['UNet','NestedUNET','AttentionUNet','SAMUNet', 'MixAttentionUNet','ASPPUNet','PYBUNet', 'SEBUNet', 'SAMUNet2','VITUNet','SAMNestedUnet','SKSAMUNet','SKSAMUNetV2','R2AttentionUNet','R2AttentionUnetSAM','MixAttentionUNetClicks']
    hyper_model = ['UNet','NestedUNET','AttentionUNet','SAMUNet', 'MixAttentionUNet','MixAttentionUNetClicks']
    ...
    hyper_crop_size = [96,64]
    hyper_meta = ['meta','meta_filtered']
    sep = True
    ...
    for batch_size, model_test, augmentation, learning_rate, loss_smooth, crop_size, metas in hyperparameter_combinations:         
        ...
        file_name = config['name'] + 'new_interactive_segmentation_false_batch_size_{}_epochs_{}_crop_{}'.format(batch_size, config['epochs'], str(crop_size))
        ...
        if os.name == 'nt':
            ...
            IMAGE_DIR = 'F:/data/lidc/Clicked/Image' + str(crop_size)
            MASK_DIR = 'F:/data/lidc/Clicked/Mask' + str(crop_size)
        else:
            print("Running on Linux")
            IMAGE_DIR = '/nas-ctm01/homes/vbreis/data/IS/ImageCL' + str(crop_size)
            MASK_DIR = '/nas-ctm01/homes/vbreis/data/IS/MaskCL' + str(crop_size)
