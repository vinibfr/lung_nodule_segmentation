...
def main_hyper():
    ...
    for batch_size, model_test, augmentation, learning_rate, loss_smooth, crop_size, metas in hyperparameter_combinations:               
        ...
        file_name = config['name'] + 'clicks_Aug_True_batch_size_{}_epochs_{}_crop_{}_{}'.format(batch_size, config['epochs'], str(crop_size),metas)
        ...
        if os.name == 'nt':
            ...
            IMAGE_DIR = '/nas-ctm01/datasets/public/LIDC/Image096'
            MASK_DIR = '/nas-ctm01/datasets/public/LIDC/Mask096'
        ...
        # Create Dataset
        train_dataset = MyLidcDataset(train_image_paths, train_mask_paths,crop_size,config['augmentation'],False)
        val_dataset = MyLidcDataset(val_image_paths,val_mask_paths,crop_size,False,False)
