...
def main_hyper():
    ...
    for batch_size, model_test, augmentation, learning_rate, loss_smooth, crop_size, metas in hyperparameter_combinations:               
        ...
        config['channels'] = 1
        file_name = config['name'] + 'lndb_Aug_True_batch_size_{}_epochs_{}_crop_{}_meta'.format(batch_size, config['epochs'], str(crop_size))
        ...
        if os.name == 'nt':
            ...
            IMAGE_DIR = 'F:/mestrado/framework_lung_segmentation/preprocessing/data_noseg/image'
            MASK_DIR = 'F:/mestrado/framework_lung_segmentation/preprocessing/data_noseg/masks'        
        else:
